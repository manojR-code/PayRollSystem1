...
export default function MiniDrawer() {
  ...
  let [logined, setlogined] = React.useState(false);
  return (
    (!logined) ? <LoginPage setlogined={setlogined} /> :
      <>
        <Box sx={{ display: 'flex' }}>
          <CssBaseline />
          ...
          <Drawer variant="permanent" open={open}>
            ...
            <Divider />
            <List>
              {['Home', 'Registaration Forms', 'Payments','Drawing'].map((text, index) => (
                <ListItem key={text} disablePadding sx={{ display: 'block', }}>
                  ...
                  >
                    ...
                    >
                      {index === 0 ? <HomeIcon /> : index === 1 ? <AppRegistrationIcon /> : index == 2 ? <CurrencyRupeeIcon /> : index == 3? <DrawIcon /> : <MailIcon/>}
                    </ListItemIcon>
                    <ListItemText
                      primary={text}
                      sx={[
